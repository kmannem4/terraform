...
data "azurerm_log_analytics_workspace" "example" {
  name                = "loganalytics-shared-01"
  resource_group_name = "rg-shared-westus2-01"
}

module "virtual-machine" {
  source  = "amn-az-tfm-virtual-machine"
  version = "1.0.0"

  # Resource Group, location, VNet and Subnet details
  resource_group_name  = "rg-shared-westus2-01"
  location             = "westus2"
  virtual_network_name = "vnet-shared-hub-westus2-001"
...
data "azurerm_network_security_group" "example" {
  ...
  resource_group_name = "vnet-shared-hub-westus2-001"
}
...
`vm_time_zone`|Specifies the Time Zone which should be used by the Virtual Machine. Ex. `"UTC"` or `"US West 2 PST"` |string|`null`
...
Developed by [Venkad Rajasekaran](mailto:venkad.rajasekaran@amnhealthcare.com).
