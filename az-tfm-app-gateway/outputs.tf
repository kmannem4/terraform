...
output "frontend_ip_configuration_name" {
  ...
  value       = azurerm_application_gateway.main.frontend_ip_configuration.*.name
}

output "backend_address_pool_name" {
  description = "The Name of the Backend Address Pool"
  value       = azurerm_application_gateway.main.backend_address_pool.*.name
}

output "backend_http_settings_name" {
  description = "The Name of the Backend HTTP Settings Configuration"
  value       = azurerm_application_gateway.main.backend_http_settings.*.name
}

output "gateway_ip_configuration_name" {
  description = "The Name of the Gateway IP Configuration"
  value       = azurerm_application_gateway.main.gateway_ip_configuration.*.name
}

output "http_listener_name" {
  description = "The Name of the HTTP Listener"
  value       = azurerm_application_gateway.main.http_listener.*.name
}

output "request_routing_rule_name" {
  description = "The Name of the Request Routing Rule"
  value       = azurerm_application_gateway.main.request_routing_rule.*.name
}
