...
output "app_gateway_name" {
  ...
  value       = module.application-gateway.app_gateway_name
}

output "frontend_ip_configuration_name" {
  description = "The Name of the Frontend IP Configuration"
  value       = module.application-gateway.frontend_ip_configuration_name
}

output "backend_address_pool_name" {
  description = "The Name of the Backend Address Pool"
  value       = module.application-gateway.backend_address_pool_name
}

output "backend_http_settings_name" {
  description = "The Name of the Backend HTTP Settings Configuration"
  value       = module.application-gateway.backend_http_settings_name
}

output "gateway_ip_configuration_name" {
  description = "The Name of the Gateway IP Configuration"
  value       = module.application-gateway.gateway_ip_configuration_name
}

output "http_listener_name" {
  description = "The Name of the HTTP Listener"
  value       = module.application-gateway.http_listener_name
}

output "request_routing_rule_name" {
  description = "The Name of the Request Routing Rule"
  value       = module.application-gateway.request_routing_rule_name
}
